...
class RouteScoreRequest(BaseModel):
    ...
    historicalDisruptions: Optional[int] = Field(default=0, description="Count of past incidents on this route")
    bridgeCondition: Optional[str] = Field(default="operational", description="operational/damaged/closed")
    congestionLevel: Optional[str] = Field(default="low", description="low/moderate/high/blocked")
...
class DisruptionPredictRequest(BaseModel):
    ...
    recentIncidents: Optional[int] = Field(default=0, description="Recent incident count for this district")
...
class RouteSuggestRequest(BaseModel):
    ...
    # Real DB-sourced fields
    historicalDisruptions: Optional[int] = Field(default=0, description="Past disruptions on this corridor")
    rainfallMm: Optional[float] = Field(default=12.0, description="Current 24h rainfall in mm")
