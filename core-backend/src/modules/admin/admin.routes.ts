...
import { createAlertSchema, createUserSchema } from '../../middleware/validation.schemas';
import { DataSourceHealthController } from './dataSourceHealth';
...
router.post('/alerts', validate(createAlertSchema), AdminController.createAlert);
...
router.patch('/field-reports/:id/dismiss', AdminController.rejectFieldReport);
