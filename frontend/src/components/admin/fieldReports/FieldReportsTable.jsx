    ...
    <div className="card" style={{ marginBottom: '24px' }}>
      ...
      <div className="filter-toolbar">
        <div className="filter-controls-group">
          ...
          >
            <span>📅 {new Date(Date.now() - 3*86400000).toLocaleDateString('en-GB', { day: 'numeric', month: 'short' })} - {new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
          </div>
        </div>
