...
export default function DynamicRerouteModal({ isOpen, onClose, vehicles = [], onRerouted }) {
  ...
  useEffect(() => {
    if (isOpen && candidateVehicles.length > 0 && !selectedVehicleId) {
      setSelectedVehicleId(candidateVehicles[0].id);
    }
  }, [isOpen, candidateVehicles, selectedVehicleId]);
